...
public class CreditAbstractAccount extends AbstractAccount {

    private double creditLimit;
    private double commission;

    public CreditAbstractAccount(Customer customer, double balance, double creditLimit, double commission) {
