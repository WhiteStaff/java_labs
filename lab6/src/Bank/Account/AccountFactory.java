...
public class AccountFactory {
    ...
    public Account createCreditAccount(Customer customer, double balance, double limit) {
    ...
    public Account createUsualAccount(Customer customer, double balance) {
    ...
    public Account createDepositAccount(Customer customer, double balance, Date date, double percents) {
